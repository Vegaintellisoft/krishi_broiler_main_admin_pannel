...
const BroilerSalesEmpDefault = () => {
    ...
    const fetchMaster = async () => {
        setIsLoading(true)
        try {
            const { data } = await axios.get("broiler/master/getAll/broiler_sales_emp_default");
            setData(data.data);
        }
        catch (err) {
            console.log("Error fetching broiler sales emp default:", err)
        } finally {
    ...
    const handleExport = () => {
        ...
        ExcelExport(data, "broiler_sales_emp_default.xlsx");
    };
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex space-x-4">
                            <div className="relative">
                                ...
                                <input
                                    type="search"
                                    placeholder="Search Broiler sales e..."
                                    value={searchQuery}
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="divide-y font-poppins capitalize">
                            {paginatedData.length > 0 ? (
                                ...
                                <tr>
                                    <td
                                        colSpan="4" // Adjusted to 4 since only 4 columns remain (S.No, Mandt, Werks, zzdispBy)
...
export default BroilerSalesEmpDefault;