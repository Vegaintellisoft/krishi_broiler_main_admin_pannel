...
const LineMaster = () => {
    ...
    const fetchMaster = async () => {
        setIsLoading(true)
        try {
            const { data } = await axios.get("broiler/master/getAll/line_master");
            setData(data.data);
        }
        catch (err) {
            console.log("Error fetching Line Master:", err)
        } finally {
            setIsLoading(false)
        }
    }
    ...
    const handleExport = () => {
        ...
        ExcelExport(data, "line_master.xlsx");
    };
        ...
        <div className="rounded-lg shadow flex-1">
            ...
            <div className="bg-[#F9F9FC] h-screen relative">
                <div className="space-y-4 pt-3 px-6 font-poppins">
                    <h1 className="text-xl font-bold text-gray-900">Line Master</h1>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex space-x-4">
                            <div className="relative">
                                ...
                                <input
                                    type="search"
                                    placeholder="Search Line Master..."
                                    value={searchQuery}
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="divide-y font-poppins capitalize">
                            {paginatedData.length > 0 ? (
                                ...
                                <tr>
                                    <td
                                        colSpan="5" // Updated colspan from 8 to 5 (removed Status and Actions columns)
