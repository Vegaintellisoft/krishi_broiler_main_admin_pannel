...
const BroilerShedIncentive = () => {
    ...
    const fetchMaster = async () => {
        setIsLoading(true)
        try {
            const { data } = await axios.get("broiler/master/getAll/broiler_shed_incentive_details");
            setData(data.data);
        }
        catch (err) {
            console.log("Error fetching broiler shed incentive details:", err)
        } finally {
    ...
    const handleExport = () => {
        ...
        ExcelExport(data, "broiler_shed_incentive_details.xlsx");
    };
        ...
        <div className="rounded-lg shadow flex-1">
            <div className="bg-[#F9F9FC] h-screen relative">
                <div className="space-y-4 pt-3 px-6 font-poppins">
                    <h1 className="text-xl font-bold text-gray-900">Broiler Shed Incentive Details</h1>
                    <div className="flex items-center gap-x-2 text-sm text-gray-500">
                        <Link to="/" className="text-orange-500">
                            Masters
                        </Link>
                        <RiArrowUpSFill className="rotate-90" size={20} />
                        <span>Broiler Shed Incentive Details</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex space-x-4">
                            <div className="relative">
                                ...
                                <input
                                    type="search"
                                    placeholder="Search Broiler Shed..."
                                    value={searchQuery}
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="divide-y font-poppins capitalize">
                            {paginatedData.length > 0 ? (
                                ...
                                <tr>
                                    <td
                                        colSpan="4" // Adjusted to 4 since only 4 columns remain (S.No, Mandt, Werks, begda)
...
export default BroilerShedIncentive;