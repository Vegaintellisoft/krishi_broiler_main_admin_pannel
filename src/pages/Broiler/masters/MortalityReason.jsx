...
const MortalityReason = () => {
    ...
    const fetchMaster = async () => {
        ...
        try {
            ...
            console.log("Error fetching broiler mortality reason:", err)
        } finally {
            setIsLoading(false)
        }
    }
    ...
    const handleExport = () => {
        ...
        ExcelExport(data, "broiler_mortality_reason.xlsx");
    };
    ...
    const filteredData = data.filter(
        (item) =>
            ...
            item.rsTxt.toLowerCase().includes(searchQuery.toLowerCase())
    );
        ...
        <div className="rounded-lg shadow flex-1">
            ...
            <div className="bg-[#F9F9FC] h-screen relative">
                <div className="space-y-4 pt-3 px-6 font-poppins">
                    <h1 className="text-xl font-bold text-gray-900">Broiler Mortality Reason</h1>
                    <div className="flex items-center gap-x-2 text-sm text-gray-500">
                        <Link to="/" className="text-orange-500">
                            Masters
                        </Link>
                        <RiArrowUpSFill className="rotate-90" size={20} />
                        <span>Broiler Mortality Reason</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex space-x-4">
                            <div className="relative">
                                ...
                                <input
                                    type="search"
                                    placeholder="Search Mortality Reason..."
                                    value={searchQuery}
