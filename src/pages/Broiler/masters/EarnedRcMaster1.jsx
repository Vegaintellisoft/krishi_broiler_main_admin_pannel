...
const EarnedRcMaster1 = () => {
    ...
    const fetchMaster = async () => {
        ...
        try {
            ...
            console.log("Error fetching Earned RC Master-1:", err)
        } finally {
            setIsLoading(false)
        }
    }
    ...
    const handleExport = () => {
        ...
        ExcelExport(data, "earned_rc_master1.xlsx");
    };
        ...
        <div className="rounded-lg shadow flex-1">
            ...
            <div className="bg-[#F9F9FC] h-screen relative">
                <div className="space-y-4 pt-3 px-6 font-poppins">
                    <h1 className="text-xl font-bold text-gray-900">Earned RC Master-1</h1>
                    <div className="flex items-center gap-x-2 text-sm text-gray-500">
                        <Link to="/" className="text-orange-500">
                            Masters
                        </Link>
                        <RiArrowUpSFill className="rotate-90" size={20} />
                        <span>Earned RC Master-1</span>
                    </div>
...
export default EarnedRcMaster1;